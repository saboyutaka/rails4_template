...
initializer 'bullet.rb', <<-CODE
  if Rails.env.development?
    Rails.application.config.after_initialize do
      Bullet.enable = true
      Bullet.alert = (ENV['#{@app_name_upcase}_BULLET_JS_ALERT'] = '1')
      Bullet.console = true
...
if yes?("Do you want to use POW?")
  file '.powenv', <<-CODE
    ENV['#{@app_name_upcase}_BETTER_ERRORS_EDITOR_SUBLIME'] = '1'
    ENV['#{@app_name_upcase}_BULLET_JS_ALERT'] = '1'
    ENV['#{@app_name_upcase}_PROFILER_DISABLE'] == '1'
  CODE
